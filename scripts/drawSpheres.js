...
function drawSpheres() {
    ...
    function drawScene(time) {
        ...
        var target = [0, 0, 0];
        var up = [0, 1, 0];
//        var worldMatrix1 = m4.xRotation(objects[33].xRotation * time);
//      worldMatrix1 = m4.yRotate(worldMatrix1, objects[33].yRotation * time);
//      worldMatrix1 = m4.translate(worldMatrix1, 0, 0, objects[33].radius);
//        
//        var worldMatrix2 = m4.xRotation(objects[45].xRotation * time);
//      worldMatrix2 = m4.yRotate(worldMatrix2, objects[45].yRotation * time);
//      worldMatrix2 = m4.translate(worldMatrix2, 0, 0, objects[45].radius);
